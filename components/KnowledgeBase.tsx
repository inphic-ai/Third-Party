...
import { BookOpen, Search, Tag, ChevronDown, ChevronRight, ExternalLink, Calendar } from 'lucide-react';
import { MOCK_KNOWLEDGE_BASE, MOCK_VENDORS } from '../constants';
...
export const KnowledgeBase: React.FC = () => {
  ...
  const filteredItems = useMemo(() => {
    return MOCK_KNOWLEDGE_BASE.filter(item => {
      // Logic: Split search query into terms. ALL terms must be present in either question, answer, or tags.
