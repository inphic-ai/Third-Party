...
import { Vendor, Region, EntityType, ServiceType, VendorCategory, ContactStatus, TransactionStatus, AdminUser, SystemLog, LoginLog, Subscription, AiModelRule, SystemTags, TutorialTip, Announcement, KnowledgeBaseItem } from './types';
...
export const MOCK_LOGS: SystemLog[] = [
  { id: 'l1', timestamp: '2024-03-15 14:30', user: 'Alex Chen', action: '更新資源', target: 'Firebase Studio', details: '修改了描述與標籤' },
  { id: 'l2', timestamp: '2024-03-15 11:20', user: 'Sarah Lin', action: '新增資源', target: 'Midjourney', details: '建立新項目' },
  { id: 'l3', timestamp: '2024-03-14 16:45', user: 'Alex Chen', action: '系統設定', target: 'API Key', details: '更新了 Gemini API Key' },
  { id: 'l4', timestamp: '2024-03-14 09:15', user: 'Emily Wu', action: '刪除資源', target: 'Old Tool', details: '移除非必要項目' },
];
