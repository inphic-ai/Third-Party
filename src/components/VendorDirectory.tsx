...
import { ContactLogModal } from './VendorDetail';
              ...
              >
                 ...
                 <td className="px-6 py-4 font-bold text-gray-800">
                    <Link to={`/vendors/${v.id}`} className="flex items-center gap-3 hover:text-blue-600 group">
                       <img src={v.avatarUrl} className="w-8 h-8 rounded-full group-hover:scale-105 transition" />
                       {v.name}
                    </Link>
                 </td>
