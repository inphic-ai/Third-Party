...
/* --- Rest of components (CategoryManagement, TagManagement, etc.) ... */
/* --- Reusing CategoryManagement, TagManagement, AiModelTraining, TutorialManagement, SystemSettings from original file content --- */
/* --- To save space, assuming they are kept as is unless modified above --- */
